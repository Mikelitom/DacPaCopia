      ...
      <Dialog
        ...
        onOpenChange={(open) => {
          if (!open) {
            // Primero actualiza el estado para cerrar el diálogo
            setIsEditingAdmin(false)
            // Luego limpia el estado del administrador actual con un pequeño retraso
            setTimeout(() => setCurrentAdmin(null), 100)
          }
        }}
      >
              ...
              <div className="grid gap-4 py-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCurrentAdmin({ ...currentAdmin, nombre_completo: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCurrentAdmin({ ...currentAdmin, correo: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setCurrentAdmin({ ...currentAdmin, rol: e.target.value })}
                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    <option value="admin">Administrador</option>
                    <option value="padre">Padre</option>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCurrentAdmin({ ...currentAdmin, departamento: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setCurrentAdmin({ ...currentAdmin, telefono: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setCurrentAdmin({ ...currentAdmin, estado: e.target.value })}
                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  >
              ...
              <DialogFooter>
                ...
                <Button
                  onClick={async () => {
                    ...
                    // No es necesario hacer nada más aquí, ya que handleUpdateAdmin ya maneja el cierre
                  }}
